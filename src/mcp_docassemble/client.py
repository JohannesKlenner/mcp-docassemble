...
class DocassembleClient(DocassembleClientEnhanced):
    ...
    def _detect_docassemble_version(self) -> Optional[str]:
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/api/config", timeout=self.timeout
            )
    ...
    def _graceful_fallback(self, feature_name: str, fallback_result: Any = None):
        ...
        if not self.enable_fallbacks:
            raise DocassembleAPIError(
                f"Feature '{feature_name}' not supported in this Docassemble version"
            )
        ...
        return fallback_result or {
            ...
            "message": "Feature not available in this version",
        }
    ...
    def _request(
        ...
        try:
            ...
            raise DocassembleAPIError(
                error_msg, status_code=response.status_code, response_data=response.text
            )
    ...
    def create_user(
        ...
        subdivisionfirst: Optional[str] = None,
        subdivisionsecond: Optional[str] = None,
        subdivisionthird: Optional[str] = None,
    ...
    def list_users(
        self, include_inactive: bool = False, next_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def add_privilege_to_role(self, privilege_name: str) -> None:
        ...
        return self._request(
            "POST", "/api/privileges", data={"privilege": privilege_name}
        )
    ...
    def give_user_privilege(self, user_id: int, privilege: str) -> None:
        ...
        """
        return self._request(
            "POST", f"/api/user/{user_id}/privileges", data={"privilege": privilege}
        )
    ...
    def remove_user_privilege(self, user_id: int, privilege: str) -> None:
        ...
        """
        return self._request(
            "DELETE", f"/api/user/{user_id}/privileges", params={"privilege": privilege}
        )
    ...
    def delete_user_interview_sessions(
        self,
        i: Optional[str] = None,
        session: Optional[str] = None,
        query: Optional[str] = None,
    ...
    def delete_user_sessions_by_id(
        self,
        user_id: int,
        i: Optional[str] = None,
        session: Optional[str] = None,
    ...
    def list_advertised_interviews(
        self, tag: Optional[str] = None, absolute_urls: bool = True
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_resume_url(
        self, i: str, session: str, expire: int = 15, url_args: Optional[Dict] = None
    ) -> str:
        """
    ...
    def get_redirect_url(
        self, url: str, expire: int = 3600, one_time: bool = False
    ) -> str:
        """
    ...
    def start_interview(
        self, i: str, secret: Optional[str] = None, **url_args
    ) -> Dict[str, Any]:
        """
    ...
    def get_interview_variables(
        self, i: str, session: str, secret: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def go_back_in_interview(
        self, i: str, session: str, secret: Optional[str] = None, question: bool = True
    ) -> Optional[Dict[str, Any]]:
        """
    ...
    def install_playground_packages(
        self,
        ...
        return self._request(
            "POST", "/api/playground_install", data=data, files=packages
        )
    ...
    def pull_package_to_playground(
        self,
        user_id: Optional[int] = None,
        project: str = "default",
    ...
    def update_server_config(self, config_changes: Dict[str, Any]) -> Dict[str, str]:
        ...
        """
        return self._request(
            "PATCH", "/api/config", data={"config_changes": config_changes}
        )
    ...
    def install_or_update_package(
        ...
        return self._request(
            "POST", "/api/package", data=data, files=files if files else None
        )
    ...
    def get_package_update_status(self, task_id: str) -> Dict[str, Any]:
        ...
        """
        return self._request(
            "GET", "/api/package_update_status", params={"task_id": task_id}
        )
    ...
    def get_user_api_keys(
        self, api_key: Optional[str] = None, name: Optional[str] = None
    ...
    def update_user_api_key(
        ...
        remove_from_permissions: Optional[Union[str, List[str]]] = None,
    ) -> None:
        """
    ...
    def get_user_api_keys_by_id(
        self, user_id: int, api_key: Optional[str] = None, name: Optional[str] = None
    ) -> Union[Dict[str, Any], List[Dict[str, Any]]]:
        """
    ...
    def delete_user_api_key_by_id(self, user_id: int, api_key: str) -> None:
        ...
        """
        return self._request(
            "DELETE", f"/api/user/{user_id}/api", params={"api_key": api_key}
        )

    def create_user_api_key_by_id(
        self,
        user_id: int,
        name: str,
        method: str = "none",
    ...
    def extract_template_fields(
        self, template_file: Any, format: str = "json"
